...
| PR | Issue | Branch | Status (as of 2026-07-15) |
|----|-------|--------|--------------------------|
...
| [#40978](https://github.com/magento/magento2/pull/40978) | [#40368](https://github.com/magento/magento2/issues/40368) | `fix/issue-40368-mediagallery-typo` | **FULLY CLEAN** — DB Compare re-run cleared spurious fail; CI note posted; triaged 2026-07-15 (pending review, P4); ⚠️ competes with stale #40360 |
